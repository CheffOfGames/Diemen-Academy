...
class LoginScreen(Screen):
    def __init__(self, root: Tk, screens: dict, database, user="", usertype:int=-1):
        ...
        # Create rectangle around buttons and labels
        self.canvas.create_rectangle((self.width/2.75), (self.height/2.75), (self.width-self.width/2.75), (self.height/1.75))
        ...
        # Submit button
        Button(self.frame, text="Submit", command=lambda: self.login()).place(x=(self.width/2), y=(self.height/1.9), anchor='center')
